        ...
        <v-col cols="12" md="10" v-resize="onResize">
            ...
            >
                    <template v-slot:item="props">
                      <tr>
                        <td align="left">{{ props.item.custdisplay }}</td>
                    ...
                    >
                      <v-card>
                        <v-card-title class="pb-0 pt-0 pl-0">
                          <v-col cols="9" class="text-left body-2 text-truncate">{{item.cust_display}} - {{item.symbol }}</v-col>
                        ...
                        <v-list v-show="isExpanded(item)" dense>
                          ...
                          <v-list-item>
                            <v-list-item-content>Purchased Value:</v-list-item-content>
...
<script>
  ...
  export default {
    ...
    data: () => ({
      ...
      isMobile: false,
      headers: [
        {text: 'Customer', sortable: true, align: 'left',},
